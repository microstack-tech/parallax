...
var (
	MainnetGenesisHash = util.HexToHash("0x96b239e015d50f5c3f11b80733e5f38c95882c072719507b7be1a59db4975457")
	TestnetGenesisHash = util.HexToHash("0xfc4e2a4f3476e50d58e2bffdf886eecc5398e548ad063222d0addee27dad1a0f")
)

// TrustedCheckpoints associates each known checkpoint with the genesis hash of
// the chain it belongs to.
var TrustedCheckpoints = map[util.Hash]*TrustedCheckpoint{}

// CheckpointOracles associates each known checkpoint oracles with the genesis hash of
// the chain it belongs to.
var CheckpointOracles = map[util.Hash]*CheckpointOracleConfig{}
...
var (
	...
	AllXHashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), big.NewInt(0), util.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), &XHashConfig{CoinbaseMaturityBlocks: 0, RetargetIntervalBlocks: 10}, nil}
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), big.NewInt(0), util.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, &CliqueConfig{Period: 0, Epoch: 30000}}
...
type TrustedCheckpoint struct {
	...
	SectionHead  util.Hash `json:"sectionHead"`
	CHTRoot      util.Hash `json:"chtRoot"`
	BloomRoot    util.Hash `json:"bloomRoot"`
}

// HashEqual returns an indicator comparing the itself hash with given one.
func (c *TrustedCheckpoint) HashEqual(hash util.Hash) bool {
	if c.Empty() {
...
func (c *TrustedCheckpoint) Hash() util.Hash {
...
func (c *TrustedCheckpoint) Empty() bool {
	return c.SectionHead == (util.Hash{}) || c.CHTRoot == (util.Hash{}) || c.BloomRoot == (util.Hash{})
}
...
type CheckpointOracleConfig struct {
	...
	Signers   []util.Address `json:"signers"`
...
type ChainConfig struct {
	...
	EIP150Hash  util.Hash `json:"eip150Hash,omitempty"`  // EIP150 HF hash (needed for header only clients as only gas pricing changed)
