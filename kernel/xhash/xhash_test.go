...
func TestRemoteSealer(t *testing.T) {
	...
	if res := api.SubmitWork(types.BlockNonce{}, sealhash, util.Hash{}); res {
...
func TestHashrate(t *testing.T) {
	var (
		...
		expect   uint64
		ids      = []util.Hash{util.HexToHash("a"), util.HexToHash("b"), util.HexToHash("c")}
	)
	xhash := NewTester(nil, false)
	defer xhash.Close()
...
func TestClosedRemoteSealer(t *testing.T) {
	...
	if res := api.SubmitHashrate(hexutil.Uint64(100), util.HexToHash("a")); res {
