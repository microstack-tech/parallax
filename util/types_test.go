...
func TestHashJsonValidation(t *testing.T) {
	tests := []struct {
		...
		{"", 62, "json: cannot unmarshal hex string without 0x prefix into Go value of type util.Hash"},
		{"0x", 66, "hex string has length 66, want 64 for util.Hash"},
		{"0x", 63, "json: cannot unmarshal hex string of odd length into Go value of type util.Hash"},
		{"0x", 0, "hex string has length 0, want 64 for util.Hash"},
		{"0x", 64, ""},
		{"0X", 64, ""},
	}
	for _, test := range tests {
