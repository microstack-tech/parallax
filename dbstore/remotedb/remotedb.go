...
func (db *Database) ReadAncients(fn func(op dbstore.AncientReaderOp) error) (err error) {
	return fn(db)
}
...
func (db *Database) ModifyAncients(f func(dbstore.AncientWriteOp) error) (int64, error) {
	panic("not supported")
}
...
func New(endpoint string) (dbstore.Database, error) {
