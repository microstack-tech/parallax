...
func (b *batch) Put(key, value []byte) error {
	b.writes = append(b.writes, keyvalue{util.CopyBytes(key), util.CopyBytes(value), false})
...
func (b *batch) Delete(key []byte) error {
	b.writes = append(b.writes, keyvalue{util.CopyBytes(key), nil, true})
	b.size += len(key)
	return nil
}
