...
<Steps>
  ...
  <Step title="Start mining">
    ...
    ```bash
    ./parallaxd --mine --miner.coinbase <YOUR_ADDRESS>
    ```
    ...
    ```bash
    ./parallaxd --mine --miner.coinbase 0x1234abcd...
    ```
...
```bash
./parallaxd attach --exec "eth.getBalance('<YOUR_ADDRESS>')"
```
