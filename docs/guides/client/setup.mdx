...
<Steps>
  ...
  <Step title="Unzip the package">
    ...
    - **parallax** → the Parallax client (this is the one you’ll run)
  ...
  <Step title="Start the client">
    - **Windows / macOS**: Simply double-click `parallax` to start your Parallax node.  
