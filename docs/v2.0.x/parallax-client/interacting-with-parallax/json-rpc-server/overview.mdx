...
```sh
./parallaxd --http --http.api eth,net,web3
```
...
```sh
./parallaxd --http --http.corsdomain https://remix.ethereum.org
```
...
```sh
./parallaxd --ws --ws.port 3334 --ws.api eth,net,web3
```
...
```sh
./parallaxd --ws --ws.origins http://myapp.example.com
```
