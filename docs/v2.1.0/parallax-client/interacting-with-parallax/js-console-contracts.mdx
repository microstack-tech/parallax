...
These are all the data required to deploy the contract using the Parallax client Javascript console. Open the Javascript console using `./parallaxd attach parallax.ipc`.
