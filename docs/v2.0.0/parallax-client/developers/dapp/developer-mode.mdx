...
```sh
parallaxd --dev --http --http.api eth,web3,net --http.corsdomain "http://remix.ethereum.org"
```
...
INFO [07-27|17:33:30.439] Maximum peer count                       total=50
...
INFO [07-27|17:33:30.554] Starting peer-to-peer node               instance=Parallax/v1.0.0-stable-95cf8a9f/darwin-arm64/go1.20.6
...
INFO [07-27|17:33:30.556] IPC endpoint opened                      url=/var/folders/j2/t2yw6xxs20sfnb1qlr4hc9br0000gn/T/parallax.ipc
...
INFO [07-27|17:33:30.556] Coinbase automatically configured       address=0xa7F18aD76a5F7e1F0d5BfB2E36CeDd7eC5324b29
...
```sh
parallaxd --datadir dev-chain --dev --http --http.api web3,eth,net --http.corsdomain "remix.ethereum.org"
```
...
```sh
parallaxd --datadir dev-chain --dev --http --http.api web3,eth,net --http.corsdomain "remix.ethereum.org" --password password.txt
```
