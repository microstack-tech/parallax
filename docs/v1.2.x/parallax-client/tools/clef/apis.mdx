...
See the [external API changelog](https://github.com/ParallaxProtocol/parallax/blob/main/cmd/clef/extapi_changelog.md) for up to date information about changes to this API.
