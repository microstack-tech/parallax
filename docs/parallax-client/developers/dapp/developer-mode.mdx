...
```sh
parallax --dev --http --http.api eth,web3,net --http.corsdomain "http://remix.ethereum.org"
```
...
```sh
parallax --datadir dev-chain --dev --http --http.api web3,eth,net --http.corsdomain "remix.ethereum.org"
```
...
```sh
parallax --datadir dev-chain --dev --http --http.api web3,eth,net --http.corsdomain "remix.ethereum.org" --password password.txt
```
