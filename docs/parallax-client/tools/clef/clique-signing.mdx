...
```
$ parallaxd account new --datadir ./ddir
INFO [06-16|11:10:39.600] Maximum peer count                       total=50
...
```sh
parallaxd  --datadir ./ddir init genesis.json
```
...
```sh
parallaxd  --datadir ./ddir --signer ./clef/clef.ipc --mine
```
