...
These commands create a Parallax executable file in the `parallax/build/bin` folder that can be moved and run from another directory if required. The binary is standalone and doesn't require any additional files.
