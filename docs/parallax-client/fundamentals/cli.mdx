...
The Parallax client is primarily controlled using the command line. The Parallax client is started using the `parallax` command. It is stopped by pressing ctrl-c.
