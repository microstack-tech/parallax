...
These are all the data required to deploy the contract using the Parallax client Javascript console. Open the Javascript console using `./parallax attach parallax.ipc`.
