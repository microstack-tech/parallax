...
JSON array of addresses the running node can see. Equivalent to the offline `parallaxd account list`, but works without stopping the daemon. Uses `personal_listAccounts`.
