...
```sh
./parallax --http --http.corsdomain https://remix.ethereum.org
```
...
```sh
./parallax --ws --ws.port 3334 --ws.api eth,net,web3
```
...
```sh
./parallax --ws --ws.origins http://myapp.example.com
```
