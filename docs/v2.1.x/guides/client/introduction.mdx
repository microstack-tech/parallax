...
- [Parallax Desktop](./desktop) → The easiest way to run a node — a native desktop app with a built-in dashboard, mining UI, and one-click MetaMask connect. **Recommended for most users.**
- [Installing the Parallax client (CLI)](./setup) → Step-by-step instructions to download and run the command-line client.
...
👉 Start here: [Parallax Desktop](./desktop) (GUI) — or use the [CLI client](./setup) if you prefer the terminal.
