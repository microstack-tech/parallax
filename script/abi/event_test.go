...
func TestEventId(t *testing.T) {
	table := []struct {
		definition   string
		expectations map[string]util.Hash
	}{
		{
			definition: `[
...
func TestEventTupleUnpack(t *testing.T) {
	...
	addr := util.HexToAddress("0x00Ce0d46d924CC8437c806721496599FC3FFA268")
	testCases := []struct {
		data     string
		dest     any
		expected any
		...
		pledgeData1,
		&[]any{&util.Address{}, &bigint, &[3]byte{}},
		&[]any{
			&addr,
			&bigintExpected2,
			&[3]byte{'u', 's', 'd'},
		...
		pledgeData1,
		&[3]any{&util.Address{}, &bigint, &[3]byte{}},
		&[3]any{
			&addr,
			&bigintExpected2,
			&[3]byte{'u', 's', 'd'},
		...
		&[]any{},
		jsonEventPledge,
		"abi: cannot unmarshal util.Address in to int",
		...
		&BadEventPledge{},
		jsonEventPledge,
		"abi: cannot unmarshal util.Address in to string",
		"Can not unpack Pledge event into struct with wrong filed types",
	}, {
		pledgeData1,
		&[]any{util.Address{}, new(big.Int)},
		&[]any{},
		jsonEventPledge,
