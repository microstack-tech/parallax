...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"address[]", nil, []util.Address{{1}}, ""},
		{"address[1]", nil, []util.Address{{1}}, ""},
		{"address[1]", nil, [1]util.Address{{1}}, ""},
		{"address[2]", nil, [1]util.Address{{1}}, "abi: cannot use [1]array as type [2]array as argument"},
		{"bytes32", nil, [32]byte{}, ""},
		{"bytes31", nil, [31]byte{}, ""},
		{"bytes30", nil, [30]byte{}, ""},
		{"bytes29", nil, [29]byte{}, ""},
		...
		{"bytes", nil, util.Hash{1}, "abi: cannot use array as type slice as argument"},
		{"string", nil, "hello world", ""},
		{"string", nil, "", ""},
		{"string", nil, []byte{}, "abi: cannot use slice as type string as argument"},
		{"bytes32[]", nil, [][32]byte{{}}, ""},
		{"function", nil, [24]byte{}, ""},
		{"bytes20", nil, util.Address{}, ""},
		{"address", nil, [20]byte{}, ""},
		{"address", nil, util.Address{}, ""},
