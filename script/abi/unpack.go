...
var (
	...
	MaxUint256 = new(big.Int).Sub(new(big.Int).Lsh(util.Big1, 256), util.Big1)
	// MaxInt256 is the maximum value that can be represented by a int256.
	MaxInt256 = new(big.Int).Sub(new(big.Int).Lsh(util.Big1, 255), util.Big1)
)
...
func toGoType(index int, t Type, output []byte) (any, error) {
	...
	case AddressTy:
		return util.BytesToAddress(returnOutput), nil
	case HashTy:
		return util.BytesToHash(returnOutput), nil
	case BytesTy:
