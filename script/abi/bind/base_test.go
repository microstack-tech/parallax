...
func mockSign(addr util.Address, tx *types.Transaction) (*types.Transaction, error) { return tx, nil }
...
func (mt *mockTransactor) PendingCodeAt(ctx context.Context, account util.Address) ([]byte, error) {
	return []byte{1}, nil
}

func (mt *mockTransactor) PendingNonceAt(ctx context.Context, account util.Address) (uint64, error) {
	return 0, nil
}
...
func (mc *mockCaller) CodeAt(ctx context.Context, contract util.Address, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockPendingCaller) PendingCodeAt(ctx context.Context, contract util.Address) ([]byte, error) {
...
func TestPassingBlockNumber(t *testing.T) {
	...
	bc := bind.NewBoundContract(util.HexToAddress("0x0"), abi.ABI{
...
func TestUnpackIndexedStringTyLogIntoMap(t *testing.T) {
	...
	mockLog := newMockLog(topics, util.HexToHash("0x0"))
	...
	expectedReceivedMap := map[string]any{
		"name":   hash,
		"sender": util.HexToAddress("0x376c47978271565f56DEB45495afa69E59c16Ab2"),
		"amount": big.NewInt(1),
		"memo":   []byte{88},
	}
...
func TestUnpackIndexedArrayTyLogIntoMap(t *testing.T) {
	arrBytes, err := rlp.EncodeToBytes([2]util.Address{util.HexToAddress("0x0"), util.HexToAddress("0x376c47978271565f56DEB45495afa69E59c16Ab2")})
	if err != nil {
		t.Fatal(err)
	}
...
func TestUnpackIndexedFuncTyLogIntoMap(t *testing.T) {
	mockAddress := util.HexToAddress("0x376c47978271565f56DEB45495afa69E59c16Ab2")
	...
	topics := []util.Hash{
		...
		util.BytesToHash(functionTyBytes),
	}
	mockLog := newMockLog(topics, util.HexToHash("0x5c698f13940a2153440c6d19660878bc90219d9298fdcf37365aa8d88d40fc42"))
...
func TestTransactGasFee(t *testing.T) {
	...
	bc := bind.NewBoundContract(util.Address{}, abi.ABI{}, nil, mt, nil)
...
func newMockLog(topics []util.Hash, txHash util.Hash) types.Log {
	return types.Log{
		Address:     util.HexToAddress("0x0"),
		Topics:      topics,
		Data:        hexutil.MustDecode(hexData),
		BlockNumber: uint64(26),
		TxHash:      txHash,
		TxIndex:     111,
		BlockHash:   util.BytesToHash([]byte{1, 2, 3, 4, 5}),
		Index:       7,
		Removed:     false,
	}
}
