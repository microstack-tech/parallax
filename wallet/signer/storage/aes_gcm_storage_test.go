...
func TestFileStorage(t *testing.T) {
	a := map[string]storedCredential{
		"secret": {
			Iv:         util.Hex2Bytes("cdb30036279601aeee60f16b"),
			CipherText: util.Hex2Bytes("f311ac49859d7260c2c464c28ffac122daf6be801d3cfd3edcbde7e00c9ff74f"),
		},
		"secret2": {
			Iv:         util.Hex2Bytes("afb8a7579bf971db9f8ceeed"),
			CipherText: util.Hex2Bytes("2df87baf86b5073ef1f03e3cc738de75b511400f5465bb0ddeacf47ae4dc267d"),
		},
	}
	d := t.TempDir()
...
func TestEnd2End(t *testing.T) {
	logging.Root().SetHandler(logging.LvlFilterHandler(logging.Lvl(3), logging.StreamHandler(colorable.NewColorableStderr(), logging.TerminalFormat(true))))
