...
func list(ui *headlessUi, api *core.SignerAPI, t *testing.T) ([]util.Address, error) {
	ui.approveCh <- "A"
...
func mkTestTx(from util.MixedcaseAddress) apitypes.SendTxArgs {
	to := util.NewMixedcaseAddress(util.HexToAddress("0x1337"))
	gas := hexutil.Uint64(21000)
	gasPrice := (hexutil.Big)(*big.NewInt(2000000000))
	value := (hexutil.Big)(*big.NewInt(1e18))
	nonce := (hexutil.Uint64)(0)
	data := hexutil.Bytes(util.Hex2Bytes("01020304050607080a"))
