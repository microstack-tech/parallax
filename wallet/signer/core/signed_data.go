...
func (api *SignerAPI) sign(req *SignDataRequest, legacyV bool) (hexutil.Bytes, error) {
	...
	account := wallet.Account{Address: req.Address.Address()}
...
func (api *SignerAPI) SignData(ctx context.Context, contentType string, addr util.MixedcaseAddress, data any) (hexutil.Bytes, error) {
...
func (api *SignerAPI) determineSignatureFormat(ctx context.Context, contentType string, addr util.MixedcaseAddress, data any) (*SignDataRequest, bool, error) {
	var (
		req          *SignDataRequest
	...
	default: // also case TextPlain.Mime:
		...
		if stringData, ok := data.(string); !ok {
			...
			if textData, err := hexutil.Decode(stringData); err != nil {
				...
				sighash, msg := wallet.TextAndHash(textData)
				messages := []*apitypes.NameValueType{
					{
						Name:  "message",
						Typ:   wallet.MimetypeTextPlain,
						Value: msg,
					},
				}
				req = &SignDataRequest{ContentType: mediaType, Rawdata: []byte(msg), Messages: messages, Hash: sighash}
...
// - the signature,
// - and/or any error
func (api *SignerAPI) SignTypedData(ctx context.Context, addr util.MixedcaseAddress, typedData apitypes.TypedData) (hexutil.Bytes, error) {
...
func (api *SignerAPI) signTypedData(ctx context.Context, addr util.MixedcaseAddress,
...
func (api *SignerAPI) EcRecover(ctx context.Context, data hexutil.Bytes, sig hexutil.Bytes) (util.Address, error) {
...
func UnmarshalValidatorData(data any) (apitypes.ValidatorData, error) {
	...
	return apitypes.ValidatorData{
		Address: util.BytesToAddress(addrBytes),
