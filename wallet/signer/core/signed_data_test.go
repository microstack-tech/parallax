...
func TestSignData(t *testing.T) {
	...
	a := util.NewMixedcaseAddress(list[0])
...
func TestHashStruct(t *testing.T) {
	...
	mainHash := fmt.Sprintf("0x%s", util.Bytes2Hex(hash))
	...
	domainHash := fmt.Sprintf("0x%s", util.Bytes2Hex(hash))
...
func TestTypeHash(t *testing.T) {
	mailTypeHash := fmt.Sprintf("0x%s", util.Bytes2Hex(typedData.TypeHash(typedData.PrimaryType)))
...
func TestEncodeData(t *testing.T) {
	...
	dataEncoding := fmt.Sprintf("0x%s", util.Bytes2Hex(hash))
...
func TestGnosisTypedData(t *testing.T) {
	...
	expSigHash := util.FromHex("0x28bae2bd58d894a1d9b69e5e9fde3570c4b98a6fc5499aefb54fb830137e831f")
...
func TestGnosisTypedDataWithChainId(t *testing.T) {
	...
	expSigHash := util.FromHex("0x6619dab5401503f2735256e12b898e69eb701d6a7e0d07abf1be4bb8aebfba29")
	if !bytes.Equal(expSigHash, sighash) {
		t.Fatalf("Error, got %x, wanted %x", sighash, expSigHash)
	}
}
...
func TestComplexTypedData(t *testing.T) {
	...
	expSigHash := util.FromHex("0x42b1aca82bb6900ff75e90a136de550a58f1a220a071704088eabd5e6ce20446")
	if !bytes.Equal(expSigHash, sighash) {
		t.Fatalf("Error, got %x, wanted %x", sighash, expSigHash)
	}
}
