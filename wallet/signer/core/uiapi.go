...
func (api *UIServerAPI) ListAccounts(ctx context.Context) ([]wallet.Account, error) {
...
func (api *UIServerAPI) DeriveAccount(url string, path string, pin *bool) (wallet.Account, error) {
	w, err := api.am.Wallet(url)
	if err != nil {
...
func (api *UIServerAPI) ImportRawKey(privkey string, password string) (wallet.Account, error) {
...
func (api *UIServerAPI) Export(ctx context.Context, addr util.Address) (json.RawMessage, error) {
	// Look up the wallet containing the requested signer
	wallet, err := api.am.Find(wallet.Account{Address: addr})
	if err != nil {
		return nil, err
	}
...
func (api *UIServerAPI) Import(ctx context.Context, keyJSON json.RawMessage, oldPassphrase, newPassphrase string) (wallet.Account, error) {
...
// the user
func (api *UIServerAPI) New(ctx context.Context) (util.Address, error) {
