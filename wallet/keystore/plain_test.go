...
func TestImportWalletKey(t *testing.T) {
	...
	if account.Address != util.HexToAddress("d4584b5f6229b7be90727b0fc8c6b91bb427821f") {
...
func skipIfSubmoduleMissing(t *testing.T) {
	if !util.FileExist(testsSubmodule) {
...
func TestV1_2(t *testing.T) {
	...
	addr := util.HexToAddress("cb61d5a9c4896fb9658090b597ef0e7be6f7b67e")
