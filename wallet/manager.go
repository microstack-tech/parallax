...
// cmd/parallax assumes once this func returns the backends have been already integrated.
...
func (am *Manager) Accounts() []util.Address {
	am.lock.RLock()
	defer am.lock.RUnlock()

	addresses := make([]util.Address, 0) // return [] instead of nil if empty
