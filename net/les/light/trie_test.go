...
func TestNodeIterator(t *testing.T) {
	...
	blockchain, _ := validation.NewBlockChain(fulldb, nil, chainparams.TestChainConfig, xhash.NewFullFaker(), script.Config{}, nil, nil)
	gchain, _ := validation.GenerateChain(chainparams.TestChainConfig, genesis, xhash.NewFaker(), fulldb, 4, testChainGen)
