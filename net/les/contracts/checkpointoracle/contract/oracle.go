...
func DeployCheckpointOracle(auth *bind.TransactOpts, backend bind.ContractBackend, _adminlist []util.Address, _sectionSize *big.Int, _processConfirms *big.Int, _threshold *big.Int) (util.Address, *types.Transaction, *CheckpointOracle, error) {
	parsed, err := abi.JSON(strings.NewReader(CheckpointOracleABI))
	if err != nil {
		return util.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, util.FromHex(CheckpointOracleBin), backend, _adminlist, _sectionSize, _processConfirms, _threshold)
	if err != nil {
		return util.Address{}, nil, nil, err
	}
...
func NewCheckpointOracle(address util.Address, backend bind.ContractBackend) (*CheckpointOracle, error) {
...
func NewCheckpointOracleCaller(address util.Address, caller bind.ContractCaller) (*CheckpointOracleCaller, error) {
...
func NewCheckpointOracleTransactor(address util.Address, transactor bind.ContractTransactor) (*CheckpointOracleTransactor, error) {
...
func NewCheckpointOracleFilterer(address util.Address, filterer bind.ContractFilterer) (*CheckpointOracleFilterer, error) {
...
func bindCheckpointOracle(address util.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(CheckpointOracleABI))
	if err != nil {
		return nil, err
	}
...
func (_CheckpointOracle *CheckpointOracleCaller) GetAllAdmin(opts *bind.CallOpts) ([]util.Address, error) {
	var out []any
	err := _CheckpointOracle.contract.Call(opts, &out, "GetAllAdmin")
	if err != nil {
		return *new([]util.Address), err
	}

	out0 := *abi.ConvertType(out[0], new([]util.Address)).(*[]util.Address)
...
//
// Solidity: function GetAllAdmin() view returns(address[])
func (_CheckpointOracle *CheckpointOracleSession) GetAllAdmin() ([]util.Address, error) {
...
//
// Solidity: function GetAllAdmin() view returns(address[])
func (_CheckpointOracle *CheckpointOracleCallerSession) GetAllAdmin() ([]util.Address, error) {
	return _CheckpointOracle.Contract.GetAllAdmin(&_CheckpointOracle.CallOpts)
}
