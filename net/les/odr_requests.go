...
type LesOdrRequest interface {
	...
	Validate(dbstore.Database, *Msg) error
}
...
func (r *BlockRequest) Request(reqID uint64, peer *serverPeer) error {
	...
	return peer.requestBodies(reqID, []util.Hash{r.Hash})
}

// Valid processes an ODR request reply message from the LPS network
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *BlockRequest) Validate(db dbstore.Database, msg *Msg) error {
	logging.Debug("Validating block body", "hash", r.Hash)
...
func (r *ReceiptsRequest) Request(reqID uint64, peer *serverPeer) error {
	...
	return peer.requestReceipts(reqID, []util.Hash{r.Hash})
}

// Valid processes an ODR request reply message from the LPS network
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ReceiptsRequest) Validate(db dbstore.Database, msg *Msg) error {
	logging.Debug("Validating block receipts", "hash", r.Hash)
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *TrieRequest) Validate(db dbstore.Database, msg *Msg) error {
	logging.Debug("Validating trie proof", "root", r.Id.Root, "key", r.Key)
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *CodeRequest) Validate(db dbstore.Database, msg *Msg) error {
	logging.Debug("Validating code data", "hash", r.Hash)
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ChtRequest) Validate(db dbstore.Database, msg *Msg) error {
	logging.Debug("Validating CHT", "cht", r.ChtNum, "block", r.BlockNum)
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *BloomRequest) Validate(db dbstore.Database, msg *Msg) error {
	logging.Debug("Validating BloomBits", "bloomTrie", r.BloomTrieNum, "bitIdx", r.BitIdx, "sections", r.SectionIndexList)
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *TxStatusRequest) Validate(db dbstore.Database, msg *Msg) error {
	logging.Debug("Validating transaction status", "count", len(r.Hashes))
