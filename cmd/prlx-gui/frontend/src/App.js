...
function RoutedContent() {
    ...
    return (_jsx("main", { className: "flex-1 overflow-y-auto px-12 py-14", children: _jsx(AnimatePresence, { mode: "wait", children: _jsx(motion.div, { initial: { opacity: 0, y: 6 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0 }, transition: { duration: 0.15, ease: [0.16, 1, 0.3, 1] }, children: _jsxs(Routes, { location: location, children: [_jsx(Route, { path: "/", element: _jsx(Dashboard, {}) }), _jsx(Route, { path: "/connect", element: _jsx(Connect, {}) }), _jsx(Route, { path: "/peers", element: _jsx(Peers, {}) }), _jsx(Route, { path: "/logs", element: _jsx(Logs, {}) }), _jsx(Route, { path: "/settings", element: _jsx(Settings, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }, location.pathname) }) }));
}
function TopBar() {
