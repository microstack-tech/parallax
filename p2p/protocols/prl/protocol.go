...
type NewBlockHashesPacket []struct {
	Hash   util.Hash // Hash of one particular block being announced
...
func (p *NewBlockHashesPacket) Unpack() ([]util.Hash, []uint64) {
	var (
		hashes  = make([]util.Hash, len(*p))
...
type HashOrNumber struct {
	Hash   util.Hash // Block hash from which to retrieve headers (excludes Number)
...
type GetBlockBodiesPacket []util.Hash
...
type GetNodeDataPacket []util.Hash
...
type NewPooledTransactionHashesPacket []util.Hash

// GetPooledTransactionsPacket represents a transaction query.
type GetPooledTransactionsPacket []util.Hash
