...
func (p *Peer) Handshake(network uint64, td *big.Int, head util.Hash, genesis util.Hash, forkID forkid.ID, forkFilter forkid.Filter) error {
...
func (p *Peer) readStatus(network uint64, status *StatusPacket, genesis util.Hash, forkFilter forkid.Filter) error {
