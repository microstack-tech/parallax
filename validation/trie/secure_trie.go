...
type SecureTrie struct {
	trie             Trie
	hashKeyBuf       [util.HashLength]byte
...
func NewSecure(root util.Hash, db *Database) (*SecureTrie, error) {
	if db == nil {
...
func (t *SecureTrie) GetKey(shaKey []byte) []byte {
	...
	return t.trie.db.preimage(util.BytesToHash(shaKey))
}
...
// from the database.
func (t *SecureTrie) Commit(onleaf LeafCallback) (util.Hash, int, error) {
...
func (t *SecureTrie) Hash() util.Hash {
	return t.trie.Hash()
}
