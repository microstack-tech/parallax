...
func NewTable(db dbstore.Database, prefix string) dbstore.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(dbstore.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader dbstore.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) dbstore.Iterator {
...
func (t *table) NewBatch() dbstore.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) dbstore.Batch {
...
func (t *table) NewSnapshot() (dbstore.Snapshot, error) {
...
func (b *tableBatch) Replay(w dbstore.KeyValueWriter) error {
