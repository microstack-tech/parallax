...
func NewID(config *chainparams.ChainConfig, genesis util.Hash, head uint64) ID {
...
func NewStaticFilter(config *chainparams.ChainConfig, genesis util.Hash) Filter {
...
func newFilter(config *chainparams.ChainConfig, genesis util.Hash, headfn func() uint64) Filter {
	...
	return func(id ID) error {
		...
		logging.Error("Impossible fork ID validation", "id", id)
...
func gatherForks(config *chainparams.ChainConfig) []uint64 {
	// Gather all the fork block numbers via reflection
	kind := reflect.TypeOf(chainparams.ChainConfig{})
