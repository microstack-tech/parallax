...
type NodeIterator struct {
	...
	accountHash util.Hash // Hash of the node containing the account
	codeHash    util.Hash // Hash of the contract source code
	code        []byte    // Source code associated with a contract

	Hash   util.Hash // Hash of the current entry being iterated (nil if not standalone)
