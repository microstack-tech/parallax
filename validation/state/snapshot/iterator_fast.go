...
type fastIterator struct {
	...
	root util.Hash // Root hash to reinitialize stale sub-iterators through
...
func newFastIterator(tree *Tree, root util.Hash, account util.Hash, seek util.Hash, accountIterator bool) (*fastIterator, error) {
...
func (fi *fastIterator) init() {
	...
	var positioned = make(map[util.Hash]int)
...
func (fi *fastIterator) Hash() util.Hash {
...
// element per diff layer. The returned combo iterator can be used to walk over
// the entire snapshot diff stack simultaneously.
func newFastAccountIterator(tree *Tree, root util.Hash, seek util.Hash) (AccountIterator, error) {
	return newFastIterator(tree, root, util.Hash{}, seek, true)
}

// newFastStorageIterator creates a new hierarchical storage iterator with one
// element per diff layer. The returned combo iterator can be used to walk over
// the entire snapshot diff stack simultaneously.
func newFastStorageIterator(tree *Tree, root util.Hash, account util.Hash, seek util.Hash) (StorageIterator, error) {
