...
func SlimAccount(nonce uint64, balance *big.Int, root util.Hash, codehash []byte) Account {
	slim := Account{
		Nonce:   nonce,
		Balance: balance,
	}
...
// version RLP encoded.
func SlimAccountRLP(nonce uint64, balance *big.Int, root util.Hash, codehash []byte) []byte {
