...
func secAddr(addr util.Address) []byte {
	return crypto.Keccak256(addr[:])
}

type accessTestFn func(db dbstore.Database, bhash util.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db dbstore.Database, bhash util.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db dbstore.Database, bhash util.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db dbstore.Database, bhash util.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db dbstore.Database, bhash util.Hash, num uint64) light.OdrRequest {
	...
	ci := light.StorageTrieID(sti, crypto.Keccak256Hash(testContractAddr[:]), util.Hash{})
