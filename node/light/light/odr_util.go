...
func GetCanonicalHash(ctx context.Context, odr OdrBackend, number uint64) (util.Hash, error) {
...
func GetTd(ctx context.Context, odr OdrBackend, hash util.Hash, number uint64) (*big.Int, error) {
...
func GetBodyRLP(ctx context.Context, odr OdrBackend, hash util.Hash, number uint64) (rlp.RawValue, error) {
...
// hash.
func GetBody(ctx context.Context, odr OdrBackend, hash util.Hash, number uint64) (*types.Body, error) {
...
func GetBlock(ctx context.Context, odr OdrBackend, hash util.Hash, number uint64) (*types.Block, error) {
...
func GetBlockReceipts(ctx context.Context, odr OdrBackend, hash util.Hash, number uint64) (types.Receipts, error) {
	...
	if len(receipts) > 0 && receipts[0].TxHash == (util.Hash{}) {
...
func GetBlockLogs(ctx context.Context, odr OdrBackend, hash util.Hash, number uint64) ([][]*types.Log, error) {
...
func GetTransaction(ctx context.Context, odr OdrBackend, txHash util.Hash) (*types.Transaction, util.Hash, uint64, uint64, error) {
	r := &TxStatusRequest{Hashes: []util.Hash{txHash}}
	if err := odr.RetrieveTxStatus(ctx, r); err != nil || r.Status[0].Status != validation.TxStatusIncluded {
		return nil, util.Hash{}, 0, 0, err
	}
