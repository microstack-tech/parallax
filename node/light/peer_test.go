...
func (f *fakeChain) Config() *chainparams.ChainConfig { return chainparams.MainnetChainConfig }
func (f *fakeChain) Genesis() *types.Block {
	return validation.DefaultGenesisBlock().ToBlock(rawdb.NewMemoryDatabase())
}
...
func TestHandshake(t *testing.T) {
	...
	var (
		...
		td      = big.NewInt(100)
		head    = util.HexToHash("deadbeef")
		headNum = uint64(10)
		genesis = util.HexToHash("cafebabe")
