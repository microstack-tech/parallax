...
type downloadTester struct {
	...
	stateDb dbstore.Database // Database used by the tester for syncing from peers
	peerDb  dbstore.Database // Database of the peers containing all data
	peers   map[string]*downloadTesterPeer

	ownHashes   []util.Hash                  // Hash chain belonging to the tester
	ownHeaders  map[util.Hash]*types.Header  // Headers belonging to the tester
	ownBlocks   map[util.Hash]*types.Block   // Blocks belonging to the tester
	ownReceipts map[util.Hash]types.Receipts // Receipts belonging to the tester
	ownChainTd  map[util.Hash]*big.Int       // Total difficulties of the blocks in the local chain

	ancientHeaders  map[util.Hash]*types.Header  // Ancient headers belonging to the tester
	ancientBlocks   map[util.Hash]*types.Block   // Ancient blocks belonging to the tester
	ancientReceipts map[util.Hash]types.Receipts // Ancient receipts belonging to the tester
	ancientChainTd  map[util.Hash]*big.Int       // Ancient total difficulties of the blocks in the local chain
...
func newTester() *downloadTester {
	tester := &downloadTester{
		...
		ownHashes:   []util.Hash{testGenesis.Hash()},
		ownHeaders:  map[util.Hash]*types.Header{testGenesis.Hash(): testGenesis.Header()},
		ownBlocks:   map[util.Hash]*types.Block{testGenesis.Hash(): testGenesis},
		ownReceipts: map[util.Hash]types.Receipts{testGenesis.Hash(): nil},
		ownChainTd:  map[util.Hash]*big.Int{testGenesis.Hash(): testGenesis.Difficulty()},

		// Initialize ancient store with test genesis block
		ancientHeaders:  map[util.Hash]*types.Header{testGenesis.Hash(): testGenesis.Header()},
		ancientBlocks:   map[util.Hash]*types.Block{testGenesis.Hash(): testGenesis},
		ancientReceipts: map[util.Hash]types.Receipts{testGenesis.Hash(): nil},
		ancientChainTd:  map[util.Hash]*big.Int{testGenesis.Hash(): testGenesis.Difficulty()},
	}
...
func (dl *downloadTester) HasHeader(hash util.Hash, number uint64) bool {
	return dl.GetHeaderByHash(hash) != nil
}

// HasBlock checks if a block is present in the testers canonical chain.
func (dl *downloadTester) HasBlock(hash util.Hash, number uint64) bool {
	return dl.GetBlockByHash(hash) != nil
}

// HasFastBlock checks if a block is present in the testers canonical chain.
func (dl *downloadTester) HasFastBlock(hash util.Hash, number uint64) bool {
	dl.lock.RLock()
...
func (dl *downloadTester) GetHeaderByHash(hash util.Hash) *types.Header {
	dl.lock.RLock()
	defer dl.lock.RUnlock()
...
func (dl *downloadTester) GetBlockByHash(hash util.Hash) *types.Block {
	dl.lock.RLock()
	defer dl.lock.RUnlock()
...
func (dl *downloadTester) FastSyncCommitHead(hash util.Hash) error {
...
func (dl *downloadTester) GetTd(hash util.Hash, number uint64) *big.Int {
	dl.lock.RLock()
	defer dl.lock.RUnlock()
...
// This method assumes that the caller holds at least the read-lock (dl.lock)
func (dl *downloadTester) getTd(hash util.Hash) *big.Int {
...
func (dl *downloadTester) Rollback(hashes []util.Hash) {
}
...
type downloadTesterPeer struct {
	...
	id            string
	chain         *testChain
	missingStates map[util.Hash]bool // State entries that fast sync should not return
}

// Head constructs a function to retrieve a peer's current head hash
// and total difficulty.
func (dlp *downloadTesterPeer) Head() (util.Hash, *big.Int) {
...
func (dlp *downloadTesterPeer) RequestHeadersByHash(origin util.Hash, amount int, skip int, reverse bool) error {
...
func (dlp *downloadTesterPeer) RequestBodies(hashes []util.Hash) error {
...
func (dlp *downloadTesterPeer) RequestReceipts(hashes []util.Hash) error {
...
func (dlp *downloadTesterPeer) RequestNodeData(hashes []util.Hash) error {
	dlp.dl.lock.RLock()
...
func TestCanonicalSynchronisation66Full(t *testing.T) {
	testCanonSync(t, prl.Parallax66, FullSync)
}
func TestCanonicalSynchronisation66Fast(t *testing.T) {
	testCanonSync(t, prl.Parallax66, FastSync)
}
func TestCanonicalSynchronisation66Light(t *testing.T) {
	testCanonSync(t, prl.Parallax66, LightSync)
}
...
func TestBoundedForkedSync66Full(t *testing.T) {
	testBoundedForkedSync(t, prl.Parallax66, FullSync)
}
func TestBoundedForkedSync66Fast(t *testing.T) {
	testBoundedForkedSync(t, prl.Parallax66, FastSync)
}
func TestBoundedForkedSync66Light(t *testing.T) {
	testBoundedForkedSync(t, prl.Parallax66, LightSync)
}
...
func TestEmptyShortCircuit66Full(t *testing.T) {
	testEmptyShortCircuit(t, prl.Parallax66, FullSync)
}
func TestEmptyShortCircuit66Fast(t *testing.T) {
	testEmptyShortCircuit(t, prl.Parallax66, FastSync)
}
func TestEmptyShortCircuit66Light(t *testing.T) {
	testEmptyShortCircuit(t, prl.Parallax66, LightSync)
}
...
func testBlockHeaderAttackerDropping(t *testing.T, protocol uint) {
	...
	for i, tt := range tests {
		...
		tester.downloader.synchroniseMock = func(string, util.Hash) error { return tt.result }
...
func TestForkedSyncProgress66Full(t *testing.T) {
	testForkedSyncProgress(t, prl.Parallax66, FullSync)
}
func TestForkedSyncProgress66Fast(t *testing.T) {
	testForkedSyncProgress(t, prl.Parallax66, FastSync)
}
...
func TestFailedSyncProgress66Full(t *testing.T) {
	testFailedSyncProgress(t, prl.Parallax66, FullSync)
}
func TestFailedSyncProgress66Fast(t *testing.T) {
	testFailedSyncProgress(t, prl.Parallax66, FastSync)
}
...
func TestFakedSyncProgress66Full(t *testing.T) {
	testFakedSyncProgress(t, prl.Parallax66, FullSync)
}
func TestFakedSyncProgress66Fast(t *testing.T) {
	testFakedSyncProgress(t, prl.Parallax66, FastSync)
}
func TestFakedSyncProgress66Light(t *testing.T) {
	testFakedSyncProgress(t, prl.Parallax66, LightSync)
}
...
func TestDeliverHeadersHang66Full(t *testing.T) {
	testDeliverHeadersHang(t, prl.Parallax66, FullSync)
}
func TestDeliverHeadersHang66Fast(t *testing.T) {
	testDeliverHeadersHang(t, prl.Parallax66, FastSync)
}
...
func (ftp *floodingTestPeer) Head() (util.Hash, *big.Int) { return ftp.peer.Head() }
func (ftp *floodingTestPeer) RequestHeadersByHash(hash util.Hash, count int, skip int, reverse bool) error {
	return ftp.peer.RequestHeadersByHash(hash, count, skip, reverse)
}

func (ftp *floodingTestPeer) RequestBodies(hashes []util.Hash) error {
	return ftp.peer.RequestBodies(hashes)
}

func (ftp *floodingTestPeer) RequestReceipts(hashes []util.Hash) error {
	return ftp.peer.RequestReceipts(hashes)
}

func (ftp *floodingTestPeer) RequestNodeData(hashes []util.Hash) error {
