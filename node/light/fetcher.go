...
func newLightFetcher(chain *light.LightChain, engine kernel.Engine, peers *serverPeerSet, ulc *ulc, chaindb dbstore.Database, reqDist *requestDistributor, syncFn func(p *serverPeer)) *lightFetcher {
