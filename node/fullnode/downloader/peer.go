...
type LightPeer interface {
	...
	RequestHeadersByHash(util.Hash, int, int, bool, chan *prl.Response) (*prl.Request, error)
...
type Peer interface {
	LightPeer
	RequestBodies([]util.Hash, chan *prl.Response) (*prl.Request, error)
	RequestReceipts([]util.Hash, chan *prl.Response) (*prl.Request, error)
}
...
func (w *lightPeerWrapper) RequestHeadersByHash(h util.Hash, amount int, skip int, reverse bool, sink chan *prl.Response) (*prl.Request, error) {
...
func (w *lightPeerWrapper) RequestBodies([]util.Hash, chan *prl.Response) (*prl.Request, error) {
	panic("RequestBodies not supported in light client mode sync")
}

func (w *lightPeerWrapper) RequestReceipts([]util.Hash, chan *prl.Response) (*prl.Request, error) {
