...
func StartENRUpdater(chain *validation.BlockChain, ln *enode.LocalNode) {
	newHead := make(chan validation.ChainHeadEvent, 10)
...
func currentENREntry(chain *validation.BlockChain) *enrEntry {
	return &enrEntry{
