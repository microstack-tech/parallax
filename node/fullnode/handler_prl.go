...
func (h *prlHandler) Chain() *validation.BlockChain { return h.chain }
...
func (h *prlHandler) handleBlockAnnounces(peer *prl.Peer, hashes []util.Hash, numbers []uint64) error {
	// Schedule all the unknown hashes for retrieval
	var (
		unknownHashes  = make([]util.Hash, 0, len(hashes))
