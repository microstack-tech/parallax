# bash completion for parallax-wallet
#
...
# or copy to /etc/bash_completion.d/ (root) or ~/.local/share/bash-completion/completions/parallax-wallet (user).

_parallax_wallet_bash_autocomplete() {
    local cur opts
    COMPREPLY=()
...
complete -F _parallax_wallet_bash_autocomplete -o bashdefault -o default parallax-wallet
