# zsh completion for parallax-cli
#
...
#
# Install:
#   source build/completion/parallax-cli.zsh
# or drop under a directory on $fpath (e.g. ~/.zsh/completions/_parallax-cli).
...
compdef _parallax_cli parallax-cli
